...
<div id='main-table-box'>
	<?php echo form_open( $insert_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		<div class='form-div'>
			...
			echo "<div class='full clearfix fieldset' id='app_info' style='display:none'>";
			...
			echo "<div class='full fieldset' id='own_info' style='display:none'>";
...
<script>
	...
	$("document").ready(function(){
		$("#field-con_district").attr('value','রাজশাহী');
	});
</script>