  ...
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%; height:700px;">
            ...
            url="<?php echo base_url()."librarian/daily_read_material_data"; ?>" 
    ...
    <a class="btn btn-warning"  title="<?php echo $this->lang->line("add"); ?> - <?php echo $this->lang->line("daily read books"); ?>" href="<?php echo site_url('librarian/add_daily_read_materials');?>">
