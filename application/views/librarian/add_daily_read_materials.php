...
<section class="content-header">
  <section class="content">
    <div class="box box-info custom_box">
      ...
      <form class="form-horizontal" action="<?php echo site_url().'librarian/add_daily_read_materials_action';?>" method="POST">
        <div class="box-body">
        ...
        <div class="box-footer">
          <div class="form-group">
            <div class="col-sm-12 text-center">
              ...
              <input type="button" class="btn btn-default btn-lg" value="<?php echo $this->lang->line("cancel"); ?>" onclick='goBack("librarian/daily_read_material")'/>  
            </div>
          </div>
        </div><!-- /.box-footer -->         
      </div><!-- /.box-info -->       
