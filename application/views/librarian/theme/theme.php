...
<html>
  ...
  <body class="skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <?php $this->load->view('librarian/theme/header');?>
      ...
      <?php $this->load->view('librarian/theme/sidebar'); ?>

      <!-- Content Wrapper. Contains page content --> 
      <div class="content-wrapper">
  		<?php 
        if($crud==1) 
			$this->load->view('librarian/theme/theme_crud',$output); 
        else 
			$this->load->view($body);
      ?>  
      </div><!-- /.content-wrapper -->
    ...
    <!-- Footer -->
      <?php $this->load->view('librarian/theme/footer');?>
    <!-- Footer -->
  </body>
</html>
