  ...
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%; height:700px;">
            ...
            url="<?php echo base_url()."librarian/book_list_data"; ?>" 
       ...
       <div id="tb" style="padding:3px">
            ...
            <?php $this->load->view('librarian/submenu_book'); ?> 
              
            <form class="form-inline" style="margin-top:0px"  enctype="multipart/form-data">
...
<script>       
    ...
    {               
        var details_url=base_url+'librarian/view_details/'+row.id;        
        // var edit_url=base_url+'librarian/update_book/'+row.id;
        // var delete_url=base_url+'librarian/delete_book_action/'+row.id;
    ...
    $('#barcode').click(function(){
        var url = "<?php echo site_url('librarian/barcode_generate');?>";
...
//Section for upload CSV.*********************************
    ...
    $(document.body).on('click','#pull_data',function(){
      ...
      if(fileval == '')
        ...
        $.ajax({
            url: site_url+'librarian/import_book_action_ajax',
            type: 'POST',
            data: queryString,
            async: false,
            cache: false,
