        ...
        <div class="row">
            <div class="col-xs-12 grid">
              <div class="border_gray grid_content content_grid clearfix">
                <h4 class="column-title in_center"><i class="fa fa-dot-circle-o blue"></i> <span class="blue"> <?php echo $this->lang->line("most issued books"); ?></span></h4>                  
                <?php 
                $delay=0;
                if(count($issued_book)==0) echo "<h4><div class='text-center alert alert-info'>".$this->lang->line("no data found")."</div></h4>";
                foreach($issued_book as $row) 
                { ?>
                            ...
                            <div class="mythumbnail">                            
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="mythumbnail-title">
                                           <?php echo $this->lang->line("total issued");?> <?php echo $row['total_issued']; ?> <?php echo $this->lang->line("times");?>
                                        </div>
                                    </div>
                                </div>                                    
                            </div>                          
